...
def waste_calc():
    ...
    amount_waste = int(input("""
    Please enter the approximate amount of waste 'garbage' you produce in a {} in kg: """.format(waste_time)))
    if waste_time == "Week":
...
Which is 62kg""".format(waste_time))
        ...
        print("""You produce {}kg {} garbage in a {} compared to an average New Zealander!
Which is {}% {} garbage!""".format(store_info["amount"], store_info["more_less"], waste_time, store_info["percentage"], store_info["more_less"]))
