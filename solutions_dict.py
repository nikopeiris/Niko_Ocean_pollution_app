solution_dict = {"1": """You might already have a reusable water bottle, but do you use it all the time?
...
shipped to the bottling facility and then to the store for purchase. """,
                     "2": """You can reduce the amount of waste you produce by purchasing products that come with less
...
http://www.recyclerightde.org""",
                     "3": """Whenever possible, try to avoid single-use coffee cups, disposable utensils,
...
Anything we can do to reduce our use of these products adds up to make a big impact. """,
                     "4": """You can also stock up on food in the freezer. Buy a bunch of food at the same time and store,
it in the freezer. Buying food in bulk means less packaging and less waste.
Look up online if you can buy foods in bulk from anywhere locally.""",
                     "5": """Whenever you leave the house, make sure you are carrying your own bag.
...
If you forget, just carry using your arms instead. Don’t be embarrassed to say no to single-use plastic. """,
                     "6": """Composting is an easy and natural process that takes remains of plants and kitchen waste,
...
the environment. """,
                     "7": """Rechargeable batteries will save you money in the long run and keep disposable batteries,
...
as chemicals inside the batteries can leak.""",
                     "8": """get involved. Visit pro-recycling sites and talk to others in your community about the
